    ...
    static {
        descriptionQuest = new HashMap<String, Map<String,String>>() {{
            put("PrinceOfPersia", new HashMap<String,String>() {{
                put("img/PrinceOfPersia/descriptionImage.png", "Добро пожаловать в захватывающий мир фантастических приключений и опасных испытаний! " +
        ...
        quests = Arrays.asList(new Quest(1L, "Путешествие принца Персии: Легенда о затерянной цитадели", Arrays.asList(
                        ...
                        new Question(5L, "Вы прибыли к старинному храму, который, как вы думаете, может быть ключом к нахождению цитадели. " +
                                "Что будешь делать?", "img/PrinceOfPersia/fourth_scene.png",
                        ...
                        new Question(7L, "Вы нашли затерянную цитадель, но она охраняется стражами. Как действуешь?",
                                "img/PrinceOfPersia/final_scene.png", Arrays.asList(new Answer(1L, "Начну сражение со стражами.",
                                        "Умение действовать не только силой, но и сообразительностью, могло бы помочь достичь цели, а не привести к погибели. Поражение!"),
                                new Answer(2L, "Попробую обойти стражей и незаметно проникнуть внутрь цитадели.",
                                        "В далекие времена правительство страны переживало трудные времена. Империя была раздроблена, " +
